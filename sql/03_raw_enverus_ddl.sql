...
-- Datasets included: wells, production
-- 
...
-- ----- dataset: production -----
CREATE TABLE raw_enverus."production" (
API_UWI TEXT,
API_UWI_14 TEXT,
API_UWI_14_Unformatted TEXT,
API_UWI_Unformatted TEXT,
CDFlaredGas_MCFPerDAY REAL,
CDGas_MCFPerDAY DOUBLE PRECISION,
CDInjectionGas_MCFPerDAY DOUBLE PRECISION,
CDInjectionOther_BBLPerDAY DOUBLE PRECISION,
CDInjectionSolvent_BBLPerDAY DOUBLE PRECISION,
CDInjectionSteam_BBLPerDAY DOUBLE PRECISION,
CDInjectionWater_BBLPerDAY DOUBLE PRECISION,
CDLiquids_BBLPerDAY DOUBLE PRECISION,
CDProd_BOEPerDAY DOUBLE PRECISION,
CDProd_MCFEPerDAY DOUBLE PRECISION,
CDRepGas_MCFPerDAY REAL,
CDWater_BBLPerDAY DOUBLE PRECISION,
CompletionID BIGINT,
Country TEXT,
County TEXT,
...
GasProd_MCF DOUBLE PRECISION,
InjectionGas_MCF DOUBLE PRECISION,
InjectionOther_BBL DOUBLE PRECISION,
InjectionSolvent_BBL DOUBLE PRECISION,
InjectionSteam_BBL DOUBLE PRECISION,
InjectionWater_BBL DOUBLE PRECISION,
LiquidsProd_BBL DOUBLE PRECISION,
PDFlaredGas_MCFPerDAY DOUBLE PRECISION,
PDGas_MCFPerDAY DOUBLE PRECISION,
PDLiquids_BBLPerDAY DOUBLE PRECISION,
PDProd_BOEPerDAY DOUBLE PRECISION,
PDProd_MCFEPerDAY DOUBLE PRECISION,
PDRepGas_MCFPerDAY DOUBLE PRECISION,
PDWater_BBLPerDAY DOUBLE PRECISION,
Prod_BOE DOUBLE PRECISION,
Prod_CondensateBBL REAL,
Prod_MCFE DOUBLE PRECISION,
Prod_OilBBL DOUBLE PRECISION,
ProducingDays DOUBLE PRECISION,
ProducingMonth TIMESTAMP WITHOUT TIME ZONE,
ProducingOperator TEXT,
ProductionID BIGINT,
ProductionReportedMethod TEXT,
RepGasProd_MCF REAL,
StateProvince TEXT,
TotalCompletionMonths INTEGER,
TotalProdMonths INTEGER,
UpdatedDate TIMESTAMP WITHOUT TIME ZONE,
WaterProd_BBL DOUBLE PRECISION,
WellID BIGINT,
CONSTRAINT production_pkey PRIMARY KEY (productionid));
ALTER TABLE raw_enverus."production" ADD COLUMN IF NOT EXISTS ingested_at timestamptz NOT NULL DEFAULT now();

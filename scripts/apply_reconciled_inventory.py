...
def main() -> None:
    ...
    # curated.codev_context (sql/46, nightly) reads formation_blueox_tvd, so
    ...
    print("[1d/3] rebuild curated.codev_context (sql/46; cascade victim of sql/23)", flush=True)
    _exec("codev_context", "46_codev_context.sql")
